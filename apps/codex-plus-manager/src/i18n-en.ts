...
export const EN_PLAIN: Record<string, string> = {
  ...
  "会话文件": "Session file",
  "会话导入": "Session import",
  "请粘贴 Codex++ 分享链接。": "Please paste a Codex++ share link.",
  "DreamSkin 社区": "DreamSkin Community",
  "导入 DreamSkin 主题包": "Import DreamSkin theme pack",
  "正在创建修复备份…": "Creating repair backup...",
  "正在写入会话修复…": "Writing session repair...",
  "正在更新会话索引…": "Updating session index...",
  "正在回滚已写入的会话…": "Rolling back written sessions...",
  "正在完成历史会话修复…": "Finalizing historic session repair...",
  "未配置目录": "Unconfigured directory",
  "原生 Edge / Chrome 请求标识兼容（实验）": "Native Edge / Chrome request identity compatibility (experimental)",
  "仅 Windows Edge / Chrome；下次启动 Codex++ 时应用。扩展可能持久保留请求标识。":
    "Windows Edge / Chrome only; applied on next Codex++ launch. Extensions may persist request identity.",
  "显示服务模式切换按钮；Fast 仅支持 gpt-5.4 / gpt-5.5，其他模型按 Standard 发送。":
    "Shows service mode toggle button; Fast only supports gpt-5.4 / gpt-5.5, other models send as Standard.",
  "悬浮球": "Floating widget",
  "控制下一步建议与回答大纲。": "Controls next-step suggestions and answer outline.",
  "根据当前回答生成下一步建议。": "Generates next-step suggestions based on the current answer.",
  "回答大纲": "Answer outline",
  "整理当前回答的结构。": "Organizes the structure of the current answer.",
  "导入主题包": "Import theme pack",
  "DreamSkin 社区主题": "DreamSkin community themes",
  "从 DreamSkin.cc 加载已审核主题包。": "Load reviewed theme packs from DreamSkin.cc.",
  ...
  "DreamSkin 社区暂时没有可用主题。": "No community themes currently available on DreamSkin.",
  "下载、校验并安装主题包": "Download, verify, and install theme pack",
  ...
  "导入链接": "Import link",
  "有未保存的模型修改，确定放弃吗？": "There are unsaved model modifications. Are you sure you want to discard them?",
  "保存此模型": "Save this model",
  "更新此模型配置": "Update this model configuration",
  "配置模型": "Configure model",
  "Codex 目标": "Codex target",
  "尝试从sub2api获取倍率显示": "Attempt to get multiplier display from Sub2API",
  "获取倍率": "Get multiplier",
  "保存前可先尝试从 /v1/sub2api/billing 获取上游倍率。":
    "Before saving, you can try fetching the upstream multiplier from /v1/sub2api/billing.",
  "非 Sub2API 供应商不会请求或显示倍率。": "Non-Sub2API providers will not request or display multipliers.",
  "自动压缩": "Auto-compact",
  "上下文窗口与自动压缩值无效，无法同步模型配置。":
    "Context window or auto-compact value is invalid; cannot sync model configuration.",
  ...
  "需要补充供应商模型信息时填写；不填则使用 Codex++ 默认配置（自动压缩 90%、图片原样发送）。从供应商的 models.json 或 model.json 复制，支持多个模型。":
    "Fill in when supplemental provider model info is needed; if omitted, Codex++ defaults are used (90% auto-compact, images sent as-is). Copy from the provider's models.json or model.json, supports multiple models.",
  "清除已导入的模型字段，保留上下文窗口": "Clear imported model fields while preserving the context window",
  "清除导入配置": "Clear imported configuration",
  "自动压缩留空时沿用 Codex 默认行为；填写百分比后会按该模型的上下文窗口重新计算阈值。":
    "When auto-compact is blank, Codex default behavior is used; entering a percentage recalculates the threshold based on this model's context window.",
  "当前使用中：保留此供应商的 auth 存档，避免 Codex 登录密钥覆盖供应商密钥":
    "Currently in use: preserves auth backup for this provider to prevent Codex login credentials from overwriting provider keys",
  "安全提示：网页链接中的自定义 config.toml 和 auth.json 不会执行；管理工具只会使用上方字段生成受管配置。":
    "Security Notice: custom config.toml and auth.json from web links are not executed; the manager tool only uses the fields above to generate managed configuration.",
  "从 DreamSkin.cc 安装主题": "Install theme from DreamSkin.cc",
  "检测到网页一键换肤请求。确认后会从固定社区 API 下载，并在本机重新校验大小、SHA-256、ZIP 清单与 Safe CSS。":
    "Web one-click skin request detected. Upon confirmation, it will be downloaded from the fixed community API and locally re-verified for size, SHA-256, ZIP manifest, and Safe CSS.",
  "主题版本 ID": "Theme version ID",
  "链接不能携带任意下载地址、文件路径或命令；安装后主题会进入“我的主题”，不会自动重启 Codex。":
    "Links cannot contain arbitrary download URLs, file paths, or commands; installed themes enter \"My themes\" without automatically restarting Codex.",
  "下载并安装": "Download and install",
  "Sub2API 倍率未获取": "Sub2API multiplier not fetched",
  "Stepwise 测试": "Stepwise test",
  "兼容选项未启用": "Compatibility option disabled",
  "等待下次启动 Codex++；保存设置不会自动重启": "Waiting for next Codex++ startup; saving settings will not auto-restart",
  "等待原生插件生成运行时": "Waiting for native extension to generate runtime",
  "服务已准备，等待新原生工作进程加载；尚未验收浏览器功能":
    "Service prepared, waiting for new native worker process to load; browser functionality not yet verified",
  "服务文件已恢复；扩展保留的请求标识不受此操作影响":
    "Service files restored; request identifiers retained by extensions are unaffected",
  "运行时不支持、选择不唯一或存在文件冲突；未启用兼容":
    "Runtime unsupported, selection ambiguous, or file conflict; compatibility not enabled",
  "此平台不支持原生 Edge / Chrome 兼容": "Native Edge / Chrome compatibility is not supported on this platform",
  "状态已过期；需启动本版本 Codex++ 后重新检查": "Status is stale; restart this version of Codex++ to recheck",
  "无法读取兼容状态；不代表浏览器已可用": "Unable to read compatibility status; does not mean browser is available",
  "刷新原生浏览器兼容状态": "Refresh native browser compatibility status",
  "启用原生 Edge / Chrome 请求标识兼容？\n\n受控标签页的目标网站可收到包含会话标识的 x-browser-agent 请求头。原生扩展会保留开启状态；关闭此兼容选项或恢复服务文件不会关闭扩展已保存的标识设置。\n\n此选项不代替站点授权、企业策略或浏览器操作审批。仅适配指定 Windows 原生运行时的 Edge / Chrome 稳定版扩展。\n\n保存后需由你关闭并重新启动 Codex / Codex++ 才能完成验收，不会自动重启。":
    "Enable native Edge / Chrome request identity compatibility?\n\nTarget websites of controlled tabs may receive an x-browser-agent header containing session identifiers. Native extensions will stay enabled; disabling this option or restoring service files does not revert saved extension settings.\n\nThis option does not replace site authorization, enterprise policy, or browser approval. Only compatible with specified Windows native runtime Edge / Chrome stable extensions.\n\nAfter saving, you must close and restart Codex / Codex++ to complete verification; it will not restart automatically.",
};
...
export const EN_TEMPLATE: Record<string, string> = {
  ...
  "把柔光与玫瑰带进今天的工作台。": "Bring soft glow and roses into today's workstation.",
  "选择项目 · ": "Select project · ",
  "◉  选择项目": "◉  Select project",
  "Dream Skin 副本": "Dream Skin copy",
  "模型名称重复：{0}": "Duplicate model name: {0}",
  "模型 {0} 的上下文窗口无效；请输入正整数，或使用 K/M 整数后缀。":
    "Invalid context window for model {0}; enter a positive integer or use a K/M integer suffix.",
  "模型 {0} 的自动压缩百分比无效；请输入 0 到 100 之间、最多 6 位小数的十进制数。":
    "Invalid auto-compact percentage for model {0}; enter a decimal number between 0 and 100 with up to 6 decimal places.",
  "来自 DreamSkin.cc 的已审核主题，共 {0} 套；安装前仍会在本机再次校验。":
    "Reviewed themes from DreamSkin.cc, {0} in total; re-verified locally before installation.",
  "作者：{0} · {1} · {2} 次下载": "Author: {0} · {1} · {2} downloads",
  "主题包：{0}": "Theme pack: {0}",
  "清单更新时间：{0}，当前显示 {1} / {2}": "Manifest updated: {0}, currently showing {1} / {2}",
  "当前缓存倍率：{0}x": "Cached multiplier: {0}x",
  "以下字段由 Codex++ 计算或维护，导入不会覆盖：{0}":
    "The following fields are computed or maintained by Codex++ and will not be overwritten by import: {0}",
...
export const EN_BACKEND: Record<string, string> = {
  ...
  "Dream Skin 实机验证通过。": "Dream Skin live verification passed.",
  "Dream Skin 实机验证未通过。": "Dream Skin live verification did not pass.",
  "Dream Skin 主题库已加载。": "Dream Skin theme library loaded.",
  "Dream Skin 主题已加载。": "Dream Skin theme loaded.",
  "Dream Skin 主题已创建。": "Dream Skin theme created.",
  "Dream Skin 主题已保存。": "Dream Skin theme saved.",
  "Dream Skin 主题已重命名。": "Dream Skin theme renamed.",
  "Dream Skin 主题已删除。": "Dream Skin theme deleted.",
  "已恢复目标项目默认图片。": "Restored default target project image.",
  "主题已安装，正在应用。": "Theme installed, applying...",
...
export const EN_BACKEND_PATTERNS: Array<[RegExp, string]> = [
  [/^Dream Skin 实机验证失败：(.+)$/, "Dream Skin live verification failed: $1"],
  [/^读取 Dream Skin 主题库失败：(.+)$/, "Failed to read Dream Skin theme library: $1"],
  [/^加载 Dream Skin 主题失败：(.+)$/, "Failed to load Dream Skin theme: $1"],
  [/^创建 Dream Skin 主题失败：(.+)$/, "Failed to create Dream Skin theme: $1"],
  [/^保存 Dream Skin 主题失败：(.+)$/, "Failed to save Dream Skin theme: $1"],
  [/^重命名 Dream Skin 主题失败：(.+)$/, "Failed to rename Dream Skin theme: $1"],
  [/^删除 Dream Skin 主题失败：(.+)$/, "Failed to delete Dream Skin theme: $1"],
  [/^准备 Dream Skin 主题失败：(.+)$/, "Failed to prepare Dream Skin theme: $1"],
  [/^保存 Dream Skin 活动主题失败：(.+)$/, "Failed to save active Dream Skin theme: $1"],
  [/^更新 Dream Skin 状态失败：(.+)$/, "Failed to update Dream Skin status: $1"],
  [/^同步 Dream Skin 基础主题失败：(.+)$/, "Failed to sync Dream Skin base theme: $1"],
  [/^实时应用失败，下次启动会继续应用：(.+)$/, "Live application failed; will apply on next launch: $1"],
  [/^恢复 Codex 原始外观失败：(.+)$/, "Failed to restore Codex original appearance: $1"],
  [/^恢复默认 Dream Skin 主题失败：(.+)$/, "Failed to restore default Dream Skin theme: $1"],
  [/^清理自定义 Dream Skin 图片失败：(.+)$/, "Failed to clean custom Dream Skin image: $1"],
  [/^外观配置已恢复，重启 Codex 后完整生效。(.*)$/, "Appearance restored; takes full effect after restarting Codex.$1"],
